                ...
                <div className="p-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {stats.actionBreakdown.slice(0, 5).map((item) => (
                      <span
                        key={item._id}
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getActionBadgeColor(item._id)}`}
                      >
                ...
                <div className="w-full sm:w-64">
                  ...
                  >
                    ...
                    <optgroup label="Applications">
                      ...
                      <option value="APPLICATION_STATUS_UPDATED">
                        Status Updated
                      </option>
                      {/* <option value="APPLICATION_UPDATED">
                        Application Updated
                      </option>
                      <option value="APPLICATION_DELETED">
                        Application Deleted
                      </option>
                      <option value="APPLICATION_VIEWED">
                        Application Viewed
                      </option> */}
                    </optgroup>
                    ...
                    <optgroup label="Bot Mimic">
                      <option value="BOT_PROCESS_SINGLE">
                        Bot Process Single
                      </option>
                      <option value="BOT_PROCESS_BATCH">
                        Bot Process Batch
                      </option>
                      <option value="BOT_AUTO_PROCESS">Bot Auto Process</option>
                      {/* <option value="BOT_ACTIVITY_VIEWED">
                        Bot Activity Viewed
                      </option> */}
                    </optgroup>
                  ...
                  {logs.map((log) => {
                    ...
                    return (
                      <tr key={log._id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getResourceBadgeColor(targetType)}`}
                          >
                            {targetType}
                          </span>
                        </td>
