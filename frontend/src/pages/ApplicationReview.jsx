...
import { useParams, useNavigate as _useNavigate } from "react-router-dom";
import {
  FileText,
  Briefcase,
  Calendar,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Review your application details and submission
              </p>
            </div>
            <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-start justify-between mb-4">
            ...
            <span
              className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${STATUS_COLORS[application.status]}`}
            >
                  ...
                  .map((history, index) => {
                    ...
                    return (
                      ...
                      >
                        {/* Status Dot */}
                        <div
                          className={`relative z-10 flex-shrink-0 w-8 h-8 rounded-full ${statusColors[history.status] || "bg-gray-500"} flex items-center justify-center`}
                        >
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Uploaded on {formatDate(application.createdAt)}
                      </p>
                    </div>
                  </div>
                  <button
